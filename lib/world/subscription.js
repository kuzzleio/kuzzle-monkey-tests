...
class Subscription {
  ...
  _build (depth) {
    ...
    const filtersNb = _suite.rand.integer(2, _suite.config.subscriptions.maxCompoundFilters);
    const Operand = filters.operands[_suite.rand.pick(Object.keys(filters.operands))];
    const operandFilters = [];
