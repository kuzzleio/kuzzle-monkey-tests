...
const DockerNames = require('./dockerNames');
...
class World {
  ...
  getDocument (id) {
    ...
    const index = _suite.rand.pick(Object.keys(this.documents));
    const collection = _suite.rand.pick(Object.keys(this.documents[index]));
  ...
  getSubscription () {
    const index = _suite.rand.pick(Object.keys(this.subscriptions));
    const collection = _suite.rand.pick(Object.keys(this.subscriptions[index]));
